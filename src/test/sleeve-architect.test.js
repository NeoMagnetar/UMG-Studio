...
describe('Phase 13A Sleeve Architect Mode foundation', () => {
  ...
  it('builds and adapts a live Hermes custom workflow Sleeve plan as runtime-session state', async () => {
    ...
    expect(request.sourceLibraryPolicy).toContain('No source-library mutation');
    ...
    const plan = {
      ...
      reuseDecisions: [{ id: 'reuse.customer_message', sourceId: 'PRIM.CUSTOMER.001', title: 'Customer Message Draft', reason: 'Reusable safe app-local drafting behavior.' }],
