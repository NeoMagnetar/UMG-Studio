...
function BuilderShelfHeader({ roleFilter, statusFilter, shown, total, aiInstructionCount, aiSubjectCount }: { roleFilter: string; statusFilter: string; shown: number; total: number; aiInstructionCount: number; aiSubjectCount: number }) {
