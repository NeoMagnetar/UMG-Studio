...
function BuilderShelfHeader({ roleFilter, statusFilter, shown, total, aiInstructionCount, aiSubjectCount, aiPrimaryCount }: { roleFilter: string; statusFilter: string; shown: number; total: number; aiInstructionCount: number; aiSubjectCount: number; aiPrimaryCount: number }) {
